...
- **Evidence:** `apps/api/src/server.ts` is approximately 1,647 lines, the operations module and Postgres repository are many thousands of lines, and the OpenAPI package is a handwritten description rather than generated runtime truth.
...
- **Evidence:** isolated raw-body size limits exist, but no system-wide authenticated/unauthenticated rate policy, per-tenant quotas, concurrency limits, or expensive-operation budget was demonstrated.
...
- **Evidence:** a large hand-routed API and handwritten contracts make it difficult to prove every boundary validates bodies, params, query strings, enums, size, and unknown fields.
...
| PRR-012 modular API/generated contracts      | P2       | CP12          | Open           | Hard                       |
...
| PRR-017 rate/resource/abuse control          | P2       | CP12/CP14     | Open           | Hard                       |
...
| PRR-028 runtime validation/mass assignment   | P2       | CP12          | Open           | Hard                       |
