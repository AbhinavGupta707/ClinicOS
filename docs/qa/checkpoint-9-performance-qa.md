...
The acceptance test also exercises current domain authorization for the CP9-relevant permission keys: `patient.export`, `audit.read`, `break_glass.request`, `break_glass.approve`, and `security.manage`.
