...
| Durable data             | Twenty-two migrations, forced RLS, transaction-bound audit/outbox and durable clinic-day/provider/AI/FHIR recovery pass at E3; staging migration/restore and live failover remain unproven. | CP14              |
...
| Providers                | Meta/Razorpay callback, registry and reconciliation boundaries pass local E3; no live public registration or official sandbox evidence exists, and telephony remains disabled.              | CP15              |
| Native mobile            | Camera/audio, encrypted private storage and durable offline delivery pass local tests/builds; no signed physical-device distribution/storage/recovery evidence exists.                      | CP16              |
| AI/interoperability      | Fireworks AI/STT and core FHIR exchange pass local durable/validator gates; live legal/residency/model evals, deployed KMS/peer exchange and ABDM activation remain absent.                 | CP16              |
...
5. CP15 local official-provider implementation is complete; public callback registration, official sandbox E4 and telephony remain open/deferred.
6. CP16 selected local native/mobile/AI/interoperability implementation is complete; physical/live-provider/ABDM E4 remains open.
