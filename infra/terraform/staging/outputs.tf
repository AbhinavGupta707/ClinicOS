...
output "media_evidence_signing_key_arn" { value = module.platform.media_evidence_signing_key_arn }
output "malware_scanner" { value = module.platform.malware_scanner }
