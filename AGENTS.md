...
- Before launching workers, define non-overlapping namespaced ownership, master-only shared files, forbidden paths, model/effort, verification commands and early blocker reporting. If two lanes need the same implementation file, redesign or sequence them rather than accepting predictable conflicts.
