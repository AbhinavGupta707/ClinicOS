  ...
  async processWebhook(input: MetaRawWebhookInput): Promise<MetaPersistVerifiedResult> {
    ...
    try {
      return await this.#persistence.persistVerified({
        ...
        normalizedEventSha256: verified.normalizedEventSha256,
        verifiedSecretVersion: verified.verifiedSecretVersion,
        verifiedWithPreviousSecret: verified.verifiedWithPreviousSecret,
        rawBodyByteLength: verified.byteLength,
