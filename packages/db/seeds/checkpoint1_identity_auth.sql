...
cross join lateral (
  values
    ...
    ('owner_admin', 'prescription.sign'), ('owner_admin', 'media.read'), ('owner_admin', 'media.write'),
    ...
    ('doctor', 'prescription.sign'), ('doctor', 'media.read'), ('doctor', 'media.write'),
    ...
    ('assistant', 'media.read'), ('assistant', 'media.write'), ('assistant', 'billing.read'),
    ...
    ('platform_admin', 'prescription.sign'), ('platform_admin', 'media.read'), ('platform_admin', 'media.write'),
