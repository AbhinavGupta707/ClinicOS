...
export type GetMorningDashboardResponse = { readonly dashboard: { readonly date: string; readonly dataAsOf: string | null; readonly appointmentsTruncated: boolean; readonly appointmentCounts: { readonly requested: number; readonly booked: number; readonly confirmed: number; readonly checked_in: number; readonly in_consult: number; readonly completed: number; readonly cancelled: number; readonly no_show: number }; readonly totalAppointments: number; readonly clinicDayAppointments: readonly ({ readonly id: string; readonly rowVersion: number; readonly patientId: string; readonly patientName: string; readonly patientPhone: string | null; readonly patientKind: "new" | "returning"; readonly providerUserId: string; readonly providerName: string; readonly appointmentTypeId: string; readonly appointmentTypeName: string; readonly chairId: string | null; readonly chairName: string | null; readonly status: "requested" | "booked" | "confirmed" | "checked_in" | "in_consult" | "completed" | "cancelled" | "no_show"; readonly startAt: string; readonly endAt: string; readonly source: "manual" | "whatsapp" | "phone" | "call" | "walkin" | "practo" | "google" | "website" | "instagram" | "referral" | "recall_campaign"; readonly reason: string | null; readonly queueEntryId: string | null; readonly queueStatus: "waiting" | "called" | "in_consult" | "completed" | "cancelled" | null; readonly queuePosition: number | null; readonly checkedInAt: string | null; readonly updatedAt: string })[]; readonly unconfirmedAppointments: readonly (VersionedPublicResource)[]; readonly todaysAppointments: readonly (VersionedPublicResource)[]; readonly openLeads: readonly (VersionedPublicResource)[]; readonly openTasks: readonly (VersionedPublicResource)[]; readonly queue: readonly (VersionedPublicResource)[]; readonly newPatientAppointmentIds: readonly (string)[]; readonly returningPatientAppointmentIds: readonly (string)[] } };
