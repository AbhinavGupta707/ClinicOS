...
export type GetCurrentIdentityResponse = { readonly user: PublicJsonObject; readonly tenant: PublicJsonObject; readonly clinics: readonly (PublicJsonObject)[]; readonly permissions: readonly (string)[] };
